        ...
        <div class="grid gap-6 lg:grid-cols-[1fr_1fr]">
            ...
            <div class="space-y-8 rounded-[1.8rem] border border-teal/10 bg-white/80 p-5 shadow-card">
                <form @submit.prevent="saveWechatPaySettings" class="space-y-4">
                    ...
                    <label class="block text-sm text-ink/70">商户证书序列号<input x-model="settings.wechat_pay.merchant_serial_no" type="text" :placeholder="wechatPayFieldPlaceholder('merchant_serial_no')" class="mt-2 w-full rounded-2xl border-bronze/15 bg-parchment/55"></label>
                    <label class="block text-sm text-ink/70">微信支付公钥ID<input x-model="settings.wechat_pay.public_key_id" type="text" :placeholder="wechatPayFieldPlaceholder('public_key_id', 'PUB_KEY_ID_...')" class="mt-2 w-full rounded-2xl border-bronze/15 bg-parchment/55"></label>
                    ...
                    <label class="block text-sm text-ink/70">通知地址<input x-model="settings.wechat_pay.notify_url" type="text" class="mt-2 w-full rounded-2xl border-bronze/15 bg-parchment/55" placeholder="https://your-domain.com/mall/api/wechat/notify"></label>
                    <label class="block text-sm text-ink/70">APIv3 Key<input x-model="settings.wechat_pay.api_v3_key" type="password" :placeholder="wechatPayFieldPlaceholder('api_v3_key')" class="mt-2 w-full rounded-2xl border-bronze/15 bg-parchment/55"></label>
                    <label class="block text-sm text-ink/70">商户私钥<textarea x-model="settings.wechat_pay.private_key_content" :placeholder="wechatPayFieldPlaceholder('private_key_content', '-----BEGIN PRIVATE KEY-----')" class="mt-2 w-full rounded-2xl border-bronze/15 bg-parchment/55"></textarea></label>
                    <label class="block text-sm text-ink/70">微信支付公钥<textarea x-model="settings.wechat_pay.public_key_content" :placeholder="wechatPayFieldPlaceholder('public_key_content', '-----BEGIN PUBLIC KEY-----')" class="mt-2 w-full rounded-2xl border-bronze/15 bg-parchment/55"></textarea></label>
                    <div class="flex gap-2">
